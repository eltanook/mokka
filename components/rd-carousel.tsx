...
const SLIDES = [
  ...
  },
  {
    ...
    subtitle: 'Reformulación 1.8% a 1.2%',
  ...
  },
  {
    ...
    text: 'Armado de medios de cultivo y controles de pH. Evaluación teórica de vida útil estipulada en 14 días y resultados de las pruebas fisicoquímicas y sensoriales.',
    chip: 'Laboratorio',
    subtitleColor: 'text-primary',
  },
  {
    ...
    text: 'Estructura básica de costos, precio de venta y aplicación de tabla nutricional con justificación de sellos: Exceso en Azúcares, Grasas y advertencia de Cafeína.',
